...
const IconPhone = () => (
  <svg className="w-6 h-6 mr-3 text-alecrim-yellow-dark" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" /></svg>
);
...
function Contato() {
  ...
  const handleWhatsAppSubmit = (e) => {
    ...
    const urlWhatsApp = `https://wa.me/${numeroWhatsApp}?text=${encodeURIComponent(textoFormatado)}`;
    ...
    <section id="contato" className="py-20 bg-white">
      <div className="container mx-auto px-6">
        <Fade direction="down" triggerOnce>
          ...
          <p className="text-xl text-center text-gray-600 mb-12">Estamos prontos para fazer parte da sua história.</p>
        </Fade>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <Fade direction="left" duration={1200} triggerOnce>
            <div>
              ...
              <h3 className="text-2xl font-semibold text-gray-800 mb-4 mt-10">Nossa Localização</h3>
              <div className="overflow-hidden rounded-lg shadow-lg border-2 border-alecrim-yellow">
                <iframe
                  ...
                  width="100%" height="288" style={{ border: 0 }}
                  allowFullScreen="" loading="lazy" title="Localização"
                ></iframe>
              </div>
            </div>
          </Fade>
            ...
            <div>
              ...
              <form onSubmit={handleWhatsAppSubmit}>
                <div className="mb-4">
                  ...
                  <input 
                    type="text" className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-alecrim-yellow"
                ...
                <div className="mb-4">
                  ...
                  <textarea 
                    rows="5" className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-alecrim-yellow"
                    value={mensagem} onChange={(e) => setMensagem(e.target.value)} required
                  ></textarea>
                </div>
                <button type="submit" className="w-full py-3 px-6 bg-alecrim-yellow text-gray-900 font-bold rounded-lg shadow-md hover:bg-alecrim-yellow-dark transition-colors">
                  Enviar via WhatsApp
                </button>
              </form>
            </div>
