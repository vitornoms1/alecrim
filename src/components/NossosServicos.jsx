    ...
    <section className="py-20 bg-white">
      <div className="container mx-auto px-6">
        ...
        <Fade direction="up" triggerOnce>
          <div className="bg-gray-50 rounded-2xl p-8 md:p-12 text-center border border-dashed border-green-300">
            ...
            <div className="flex flex-wrap justify-center gap-3 text-green-700 font-medium italic">
